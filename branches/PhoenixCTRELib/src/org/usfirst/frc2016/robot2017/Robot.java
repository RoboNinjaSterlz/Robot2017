...
import org.usfirst.frc2016.robot2017.OI;
...
//		Scheduler.getInstance().add(new CenterSlide());
	...
	private void updateDashboard() {
		...
		SmartDashboard.putBoolean("LeftDrive Falt", Robot.currentMonitor.driveLeftFalt());
		SmartDashboard.putBoolean("RightDrive Falt", Robot.currentMonitor.driveRightFalt());
	}
}
