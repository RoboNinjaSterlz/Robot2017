...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("AutoGearRightSide", new AutoGearRightSide());
        SmartDashboard.putData("CameraDrive: 20_inches", new CameraDrive(20));
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
       ...
       // gearTrigger.whileHeld(new CompGrab());
    }
